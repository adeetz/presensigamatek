    ...
    <div class="section" id="user-section">
        ...
        <div id="user-detail">
            <div class="avatar">
                ...
                @else
                    <img src="{{ asset('images/default.png') }}" alt="avatar" class="imaged w64" style="height: 65px">
                @endif
            </div>
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div id="rekappresensi">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px !important; line-height:0.8rem">
        ...
        <!-- Presensi Bulan Ini dan Leaderboard -->
