        ...
        <table class="tabeldatakaryawan">
            <tr>
                <td rowspan="6">
                    ...
                    @endphp
                    <img src="{{ url($path) }}" alt="Foto Karyawan" class="karyawan-photo">
                </td>
            </tr>
            <tr>
                <td>NIK</td>
        ...
        <table class="tabelpresensi">
            ...
            @foreach ($presensi as $d)
                ...
                <tr>
                    ...
                    <td>{{ $d->jam_in }}</td>
                    <td><img src="{{ url($path_in) }}" alt="Foto Masuk" class="foto-presensi"></td>
                    <td>{{ $d->jam_out != null ? $d->jam_out : 'Belum Absen' }}</td>
                    <td>
                        @if ($d->jam_out != null)
                            <img src="{{ url($path_out) }}" alt="Foto Out" class="foto-presensi">
                        @else
                            <img src="{{ asset('assets/img/nopicture.png') }}" alt="" style="width: 50px; height: auto;">
                        @endif
                    </td>
                    <td>
                        @if ($d->jam_in > '09:00')
